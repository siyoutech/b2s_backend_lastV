...
public function deposite(){
    return $this->hasMany(DepositeShop::class);
}
public function depositesiyou(){
    return $this->hasMany(Depositesiyou::class);
}

    public function categories() {
        return $this->belongsToMany(category::class,'category_user','supplier_id','category_id');
    }

    // *******OLD RELATIONSHIPS*******
    public function salesmanagerToSupplier()
    {
        return $this->belongsToMany(User::class, 'supplier_salesmanager_shop_owner', 'supplier_id', 'salesmanager_id');
    }
    public function shopsToSupplier()
    {
        return $this->belongsToMany(User::class, 'supplier_salesmanager_shop_owner', 'supplier_id', 'shop_owner_id');
    }
    ...
    //     return $this->belongsToMany(User::class, 'supplier_salesmanager_shop_owner', 'salesmanager_id', 'shop_owner_id');
    // }
    ...
    public function getcategoriesThroughProducts() {
        return $this->hasManyThrough(Category::class, Product::class, 
        'supplier_id', 'id', 'id', 'category_id');
    }
    // public function suppliers()
    // {
